...
(function loadPinalAskRosie(){
  try{
    if(!location.pathname.includes('/BOOST_Pathway-Portal/'))return;
    ...
    s.src='assets/js/pinal-ask-rosie-v1.js?v=20260912rosie4';
    s.dataset.pinalAskRosie='1';
