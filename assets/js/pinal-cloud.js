(function(){
  ...
  function put(j){j=j||{};j.region=REGION;j.updated_at=new Date().toISOString();localStorage.setItem(J,JSON.stringify(j));schedule(j);return j}
  ...
  async function loadMine(){
    ...
    if(data){localStorage.setItem(J,JSON.stringify(data));restoreBrowserState(data);return data}
    return null;
  }
