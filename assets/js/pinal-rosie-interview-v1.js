...
function makeUtterance(text){const u=new SpeechSynthesisUtterance(speechText(text));const v=currentSpeechVoice(),name=String(v?.name||'').toLowerCase(),googleUS=name.includes('google us english');if(v)u.voice=v;u.lang=v?.lang||'en-US';u.rate=googleUS?.90:.92;u.pitch=googleUS?.96:.98;u.volume=1;return u}
